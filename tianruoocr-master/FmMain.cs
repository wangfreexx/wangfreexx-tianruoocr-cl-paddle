...
//                                   "&vol=9&per=0&spd=6&pit=4&source=web&ctp=1";
		...
		public void SougouOCR()
		{
			try
			{
				...
				OcrResult ocrResult = ocrEngin.Detect(((Bitmap)image_screen).ToImage<Bgr, Byte>().Mat,padding,maxSideLen,boxScoreThresh,boxThresh,unClipRatio,doAngle,mostAngle );
